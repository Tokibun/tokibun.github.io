...
<!--    </footer>-->
      <div class="footer">
          <a class="icon" href="https://www.linkedin.com/in/mkee/"> <i class="fab fa-linkedin fa-2x"></i> </a>
          <a class="icon" href="https://github.com/Tokibun"> <i class="fab fa-github fa-2x"></i></a>
      </div>
